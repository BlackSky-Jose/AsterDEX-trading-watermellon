  ...
  if (strategyType === "peach-hybrid") {
    strategy = {
      ...
      v2: {
        ...
        // Updated to match Manual Cherry: 4.0 (was 3.0)
        rsiMomentumThreshold: env.PEACH_V2_RSI_MOMENTUM_THRESHOLD ?? 4.0,
        volumeLookback: env.PEACH_V2_VOLUME_LOOKBACK ?? 4,
        // Updated to match Manual Cherry: 2.0 (was 1.5)
        volumeMultiplier: env.PEACH_V2_VOLUME_MULTIPLIER ?? 2.0,
